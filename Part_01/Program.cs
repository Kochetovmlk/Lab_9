...
namespace Task1
{
    class Program
    {
        ...
        {
            string pathToTickerFile = "C:\\Users\\mikha\\OneDrive\\Рабочий стол\\Lab_09\\Part_01\\ticker.txt";
                ...
                try
                {
                    ...
                    lock (locker)
                    {
                        using (StreamWriter streamWriter =
                               new StreamWriter("C:\\Users\\mikha\\OneDrive\\Рабочий стол\\Lab_09\\Part_01\\out.txt", true))
                        {
